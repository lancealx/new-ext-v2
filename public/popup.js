...
class NanoLOSPopup {
  ...
  initializeElements() {
    ...
    // Action buttons
    this.openDashboardBtn = document.getElementById('openDashboard');
    this.openSearchBtn = document.getElementById('openSearch');
  ...
  bindEvents() {
    ...
    [this.firstNameEl, this.lastNameEl, this.appIdEl].forEach(input => {
    ...
    // Quick actions
    this.openDashboardBtn.addEventListener('click', () => this.openUrl('https://canopymortgage.nanolos.com/'));
    this.openSearchBtn.addEventListener('click', () => this.openUrl('https://canopymortgage.nanolos.com/loan-fulfillment/#/main/search'));
    this.openOptionsBtn.addEventListener('click', () => chrome.runtime.openOptionsPage());
  ...
  async handleSearch() {
    ...
    try {
      const results = await this.searchLoans(firstName, lastName, appId);
  ...
  async searchLoans(firstName, lastName, appId) {
